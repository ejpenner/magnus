...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        File::makeDirectory(public_path('usr/'.$vilest->username.'/images'), 0755, true);
        File::makeDirectory(public_path('usr/'.$vilest->username.'/thumbnails'), 0755, true);
        File::makeDirectory(public_path('usr/'.$vilest->username.'/avatars'), 0755, true);
