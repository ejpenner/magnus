...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        File::makeDirectory(public_path('users/'.$vilest->username.'/images'), 0755, true);
        File::makeDirectory(public_path('users/'.$vilest->username.'/thumbnails'), 0755, true);
        File::makeDirectory(public_path('users/'.$vilest->username.'/avatars'), 0755, true);
